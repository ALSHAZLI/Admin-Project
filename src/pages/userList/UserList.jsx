...
export default function ProductList() {
  ...
  <table className="widgetLgTable">
    <tr className="widgetLgTr">
      ...
      <th className="widgetLgTh">Customer Phone</th>
    ...
    {users.map((user) => (
      <tr className="widgetLgTr" key={user.id}>
        <td className="widgetLgUser">
          <span className="widgetLgName">{user.id}</span>
        </td>
        <td className="widgetLgDate">{format(user.createdAt)}</td>
        <td className="widgetLgAmount">
        <span className="widgetLgName">{user.fullname}</span>
        </td>
        <td className="widgetLgAmount">
        <span className="widgetLgName">{user.phone}</span>
        </td>
        {/* <Link to="/newUser">
